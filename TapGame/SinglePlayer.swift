...
//  TapMe
//
//  Created by Winston on 28.05.2018.
...
class SinglePlayer: UIViewController {
    ...
    func gameOver(){
        ...
        let alertController = UIAlertController(title: "Game Over!", message: "Congarts!\nYou have tapped \(playerScore) times 👏\(ifitisnew)", preferredStyle: UIAlertController.Style.alert)
            
        let okAction = UIAlertAction(title: "Return to Home", style: UIAlertAction.Style.destructive) {
